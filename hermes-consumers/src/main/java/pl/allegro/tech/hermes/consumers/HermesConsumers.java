...
public class HermesConsumers {
    ...
    HermesConsumers(HooksHandler hooksHandler,
        ...
        subscriptionAssignmentsRepository = serviceLocator.getService(SubscriptionAssignmentNotifyingRepository.class);
        ...
        hooksHandler.addShutdownHook((s) -> {
            try {
                ...
                subscriptionAssignmentsRepository.stop();
    ...
    public void start() {
        try {
            ...
            subscriptionAssignmentsRepository.start();
